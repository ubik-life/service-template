...
| 10 | Собрать пакет проектной документации | папка `docs/design/<slug>/` |
...
**Вход:** все артефакты Шагов 1–9. **Выход:** папка `docs/design/<slug>/` с полным пакетом проектной документации.

Финальный артефакт проектировщика — папка `docs/design/<slug>/`:
...
`docs/design/<slug>/backlog.md` (раздел `## Хендофф`). Проектировщик заполняет
